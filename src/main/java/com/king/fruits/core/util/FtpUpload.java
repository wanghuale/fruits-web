...
import com.rogrand.kkmy.common.api.Constants;
...
public class FtpUpload {
    ...
    private static String FTP_BASEPATH = "/kkmy/upload";
    private static DateFormat dateDirFormat = new SimpleDateFormat(Constants.DATE_DIR_FORMAT);
    ...
    public String genNewFilePath(UploadType type, String fileName) {
        ...
        if (UploadType.USER_PIC == type) {
            return FTP_BASEPATH + "/picture/user/" + dateDir + "/" + fileName;
        } else if (UploadType.MERCHANT_PIC == type) {
            return FTP_BASEPATH + "/picture/merchant/" + dateDir + "/" + fileName;
