...
public class PropertiesLoader {
	...
	public static String getPValue(String key) {
		PropertiesLoader pl = new PropertiesLoader("config-local.properties");
		return pl.getProperty(key);
	}

	public static void main(String[] args) {
		System.out.println("123" + PropertiesLoader.getPValue("proxySet"));
	}
}
