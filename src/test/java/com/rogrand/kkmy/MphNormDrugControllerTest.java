...
public class MphNormDrugControllerTest extends BaseTest {
	
	private static final Logger logger = LoggerFactory.getLogger(MphNormDrugControllerTest.class);
	...
	public void getEvaluateListTest(){
		String url = "http://localhost:80/kkmy2.0/normdrug/getByCode.do";
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("code", "6936292120079");
		backInfo(map,url);
	}
