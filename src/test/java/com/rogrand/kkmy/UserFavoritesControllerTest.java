 ...
 * 描述：〈描述〉
 */
public class UserFavoritesControllerTest extends BaseTest {
	
	private static final Logger logger = LoggerFactory.getLogger(UserFavoritesControllerTest.class);
	...
	public void getUserFavoritesTest(){
		String url = "http://localhost:80/kkmy2.0/favorites/getUserFavorites.do";
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("userId", "2");
		map.put("userLongitude", "2");
		map.put("userLatitude", "2");
		backInfo(map,url);
	}
	
	@Test
	public void getEvaluateListTest(){
		String url = "http://localhost:80/kkmy2.0/favorites/getEvaluateList.do";
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("userId", "2");
		backInfo(map,url);
	}
