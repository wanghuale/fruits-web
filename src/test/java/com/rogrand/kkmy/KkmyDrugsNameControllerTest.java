 ...
 * 描述：〈描述〉
 */
public class KkmyDrugsNameControllerTest extends BaseTest {
	
	private static final Logger logger = LoggerFactory.getLogger(KkmyDrugsNameControllerTest.class);
	...
	public void merchantStatusSettingTest(){
		String url = "http://localhost:80/kkmy2.0/drugsName/getAll.do";
		backInfo(new HashMap(),url);
	}
